...
struct GameplayConfiguration {
    struct Beam {
        ...
        static let arcAngle: CGFloat = CGFloat(45.0 * (Double.pi / 180.0))
        
        // The maximum arc angle (in radians) after being adjusted for distance from target.
        static let maxArcAngle: CGFloat = CGFloat(0.35)
        ...
        static let chargeLossPerSecond: Double = 90.0
    ...
    struct PlayerBot {
        ...
        static let antennaOffset: CGPoint = CGPoint(x: 0.0, y: 50.0)
        
        // The offset of the `PlayerBot`'s charge bar from its position.
        static let chargeBarOffset: CGPoint = CGPoint(x: 0.0, y: 65.0)
        
        // The initial charge value for the `PlayerBot`'s health bar.
        static let initialCharge: Double = 100.0

        // The maximum charge value for the `PlayerBot`'s health bar.
        static let maximumCharge: Double = 100.0
        ...
        static let rechargeAmountPerSecond: Double  = 10.0
    ...
    struct FlyingBot {
        ...
        static let blastChargeLossPerSecond: Double = 25.0
        ...
        static let blastEmitterOffset: CGPoint = CGPoint(x: 0.0, y: 20.0)
        
        // The offset from the `FlyingBot`'s position that should be used for beam targeting.
        static let beamTargetOffset: CGPoint = CGPoint(x: 0.0, y: 65.0)
    }
    ...
    struct GroundBot {
        ...
        static let chargeLossPerContact: Double = 25.0
        ...
        static let preAttackRotationSpeed: Double = Double.pi / 4
        ...
        static let beamTargetOffset: CGPoint = CGPoint(x: 0.0, y: 40.0)
    }
