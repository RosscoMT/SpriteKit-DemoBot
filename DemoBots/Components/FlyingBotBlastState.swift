...
class FlyingBotBlastState: GKState {
    ...
    var animationComponent: AnimationComponent {
        ...
        guard let animationComponent = entity.component(ofType: AnimationComponent.self) else {
            fatalError("A FlyingBotBlastState's entity must have an AnimationComponent.")
        }
    ...
    var renderComponent: RenderComponent {
        ...
        guard let renderComponent = entity.component(ofType: RenderComponent.self) else {
            fatalError("A FlyingBotBlastState's entity must have a RenderComponent.")
        }
    ...
    required init(entity: TaskBot) {
        ...
        guard let flyingBotGoodAttackParticleEmitter: SKEmitterNode = SKEmitterNode(asset: .flyingBotGoodAttackParticleEmitter), let flyingBotBadAttackParticleEmitter: SKEmitterNode = SKEmitterNode(asset: .flyingBotBadAttackParticleEmitter) else {
            fatalError()
        }
        
        templateGoodEmitterNode = flyingBotGoodAttackParticleEmitter
        templateBadEmitterNode = flyingBotBadAttackParticleEmitter
    ...
    func entitiesInRange() -> [GKEntity] {
        ...
        guard let level = renderComponent.node.scene as? LevelScene else {
            return []
        }
        
        guard let entitySnapshot = level.entitySnapshotForEntity(entity: entity) else {
            return []
        }
    ...
    func performGoodBlast() {
        ...
        for taskBot in taskBotsInRange {
            ...
            guard let currentState = taskBot.component(ofType: IntelligenceComponent.self)?.stateMachine.currentState else {
                continue
            }
