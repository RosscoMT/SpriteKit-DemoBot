...
class PlayerBotRechargingState: GKState {
    ...
    var animationComponent: AnimationComponent {
        ...
        guard let animationComponent = entity.component(ofType: AnimationComponent.self) else {
            fatalError("A PlayerBotRechargingState's entity must have an AnimationComponent.")
        }
    ...
    var chargeComponent: ChargeComponent {
        ...
        guard let chargeComponent: ChargeComponent = entity.component(ofType: ChargeComponent.self) else {
            fatalError("A PlayerBotRechargingState's entity must have a ChargeComponent.")
        }
