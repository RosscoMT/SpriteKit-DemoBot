...
class GroundBotPreAttackState: GKState {
    ...
    var animationComponent: AnimationComponent {
        ...
        guard let animationComponent = entity.component(ofType: AnimationComponent.self) else {
            fatalError("A GroundBotPreAttackState's entity must have an AnimationComponent.")
        }
    ...
    override func update(deltaTime seconds: TimeInterval) {
        ...
        // If the `GroundBot` has been in its "pre-attack" state for long enough, move to the attack state.
