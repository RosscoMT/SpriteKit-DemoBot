...
class GroundBotAttackState: GKState {
    ...
    var movementComponent: MovementComponent {
        ...
        guard let movementComponent = entity.component(ofType: MovementComponent.self) else {
            fatalError("A GroundBotAttackState's entity must have a MovementComponent.")
        }
    ...
    var physicsComponent: PhysicsComponent {
        ...
        guard let physicsComponent = entity.component(ofType: PhysicsComponent.self) else {
            fatalError("A GroundBotAttackState's entity must have a PhysicsComponent.")
        }
    ...
    var targetPosition: SIMD2<Float> {
        ...
        guard let targetPosition = entity.targetPosition else {
            fatalError("A GroundBotRotateToAttackState's entity must have a targetPosition set.")
        }
    ...
    override func didEnter(from previousState: GKState?) {
        ...
        for contactedBody in contactedBodies {
            ...
            guard let entity = contactedBody.node?.entity else {
                continue
            }
    ...
    override func update(deltaTime seconds: TimeInterval) {
        ...
        // Leave the attack state if the `GroundBot` has moved further away from its target because it has been knocked off course.
