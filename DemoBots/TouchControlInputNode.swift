...
class TouchControlInputNode: SKSpriteNode, ThumbStickNodeDelegate, ControlInputSourceType {
    ...
    var leftControlTouches: Set<UITouch> = Set<UITouch>()
    var rightControlTouches: Set<UITouch> = Set<UITouch>()
    ...
    init(frame: CGRect, thumbStickNodeSize: CGSize) {
        ...
        let initialVerticalOffset: CGFloat = -thumbStickNodeSize.height
        let initialHorizontalOffset: CGFloat = frame.width / 2 - thumbStickNodeSize.width
